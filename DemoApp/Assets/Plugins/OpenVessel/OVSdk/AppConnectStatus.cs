namespace OVSdk
{
    ...
    public enum AppConnectStatus
    {
        ...
        /// <summary>
        /// Unable to connect wallet application: current application's package name is not registered in the
        /// Vessel dashboard. Please register current package name.
        /// </summary>
        ErrorAppNotRegistered,
